<h2><a href="https://www.geeksforgeeks.org/problems/number-of-digits2559/1?page=1&category=Dynamic%20Programming&sortBy=submissions">Number of digits</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a number <strong>N</strong>, find the number of digits in the&nbsp;Nth Fibonacci Number.</span><br>
&nbsp;</p>
