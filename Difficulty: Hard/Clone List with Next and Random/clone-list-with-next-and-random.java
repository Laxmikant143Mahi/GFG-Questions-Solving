...
class Solution {
    ...
    Node cloneLinkedList(Node head) {
        ...
        Node curr = head;
        while (curr != null) {
            Node newNode = new Node(curr.data); // Create a new node
            newNode.next = curr.next;           // Link it to the next node of the original
            curr.next = newNode;                // Insert it after the original node
        ...
        while (curr != null) {
            if (curr.random != null) {
                curr.next.random = curr.random.next; // Set random pointer for the cloned node
            }
        ...
        while (curr != null) {
            Node copyNode = curr.next; // The cloned node
            curr.next = copyNode.next; // Restore the original list by skipping cloned nodes
            copyCurr.next = copyNode;  // Add the cloned node to the copied list
